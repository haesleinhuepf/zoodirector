...
public class MaximumTemporalOverlapProcessor implements NeighborProcessor, TakesFormerLabelMap, TakesFormerPointlist {
    ...
    public ClearCLBuffer process(CLIJ2 clij2, ClearCLBuffer input, ClearCLBuffer pointlist, ClearCLBuffer label_map, ClearCLBuffer touch_matrix, ClearCLBuffer distance_matrix) {
        ...
        clij2.replaceIntensities(label_map, maxmimum_jaccard_vector, result);
        return result;
    }
    ...
    public String getName() {
        return "Maximum temporal overlap";
    }
