...
public class LocalMeanNumberOfTouchingNeighborsProcessor implements NeighborProcessor {
    @Override
    public ClearCLBuffer process(CLIJ2 clij2, ClearCLBuffer input, ClearCLBuffer pointlist, ClearCLBuffer label_map, ClearCLBuffer touch_matrix, ClearCLBuffer distance_matrix) {
        ...
        clij2.meanOfTouchingNeighbors(vector, touch_matrix, mean_vector);
    ...
    public String getName() {
        return "Local mean number of touching neighbors";
    }
