package net.haesleinhuepf.imagej.zoo.registration;
...
public class ImageRegistration3D implements PlugIn {
    ...
    public void run(String arg) {
        ...
        System.out.println("Building 2nd dialog");
    ...
    public static void main(String... args){
        ...
        String fixedDataSourceFolder = "C:/structure/data/2018-05-23-16-18-13-89-Florence_multisample/";
        String fixedDataSetName = "opticsprefused";
        String movingDataSourceFolder = "C:/structure/data/2018-05-23-16-18-13-89-Florence_multisample/";
        String movingDataSetName = "opticsprefused";

        ClearControlDataSetOpener.open(fixedDataSourceFolder, fixedDataSetName).show();
        ClearControlDataSetOpener.open(movingDataSourceFolder, movingDataSetName).show();
